...
public class EnvironmentService_CreateTest {
    ...
    public void shouldCreateEnvironment() throws TechnicalException {
        ...
        verify(mockAPIHeaderService, times(1)).createDefault("created_env");
        verify(mockViewService, times(1)).createDefaultView("created_env");
        verify(mockPageService, times(1)).createDefaultPages("created_env");
    }
}
