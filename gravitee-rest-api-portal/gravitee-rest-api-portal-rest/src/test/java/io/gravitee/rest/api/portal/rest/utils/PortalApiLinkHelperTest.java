...
public class PortalApiLinkHelperTest {
    ...
    private static final String BASE_URL_APIS = BASE_URL + "/organizations/DEFAULT/environments/DEFAULT" + "/apis";
    ...
    private static final String BASE_URL_APPLICATIONS = BASE_URL + "/organizations/DEFAULT/environments/DEFAULT" + "/applications";
    private static final String BASE_URL_APPLICATIONS_APPLICATIONID = BASE_URL_APPLICATIONS + "/" + APPLICATION;

    private static final String BASE_URL_PAGES = BASE_URL + "/organizations/DEFAULT/environments/DEFAULT" + "/pages";
    private static final String BASE_URL_PAGES_PAGEID = BASE_URL_PAGES + "/" + PAGE;

    private static final String BASE_URL_USER = BASE_URL + "/organizations/DEFAULT/environments/DEFAULT" + "/user";

    private static final String BASE_URL_VIEWS = BASE_URL + "/organizations/DEFAULT/environments/DEFAULT" + "/views";
